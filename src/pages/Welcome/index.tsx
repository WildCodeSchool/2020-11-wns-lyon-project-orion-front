import img from '../../assets/images/welcome-bg.jpg';
import Forget from '../../containers/Forget';
import SignIn from '../../containers/SignIn';
import React, {useState} from 'react';

type welcomeView = 'signIn' | 'forget';

const Welcome = () => {

    const [view, setView] = useState<welcomeView>(null);

    return <div className="welcome">

        <div className="bg-gray-900 flex items-center justify-center overflow-hidden">
            <img src={img} alt="Orion" className="w-full h-full object-cover"/>
        </div>

        {!view && <div className="flex items-center justify-center">

            <div className="max-w-md px-8 flex items-center justify-center flex-col">

                <svg xmlns="http://www.w3.org/2000/svg" width="152.7" height="167.031" viewBox="0 0 152.7 167.031">
                ...
                <p className="text-sm text-gray-500 mt-24 mb-10">Lorem ipsum dolor sit amet, consectetur
                    adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                <button className="w-full mb-4 btn btn-primary"
                        onClick={() => setView('signIn')}>Me connecter</button>
                <button className="w-full h-14 mb-10 btn btn-outline-secondary"
                        onClick={() => setView(null)}>Demande d'inscription</button>
                <span className="text-gray-500 text-sm">Mentions légales</span>
            </div>

        </div>}

        {view === 'signIn' && <SignIn viewHandler={setView}/>}
        {view === 'forget' && <Forget viewHandler={setView}/>}
    </div>;
}
